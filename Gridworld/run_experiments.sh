...
python grid_exp.py -name "rich gridworld actions sample 2"
echo "Running auxiliary experiments for deterministic gridworld with sparse rewards..."
python grid_exp.py --sparse -name "sparse gridworld actions sample 2"
echo "Running auxiliary experiments for stochastic gridworld with rich rewards..."
python grid_exp.py --stochastic -name "stochastic rich gridworld actions sample 2"
echo "Running auxiliary experiments for stochastic gridworld with sparse rewards..."
python grid_exp.py --stochastic --sparse -name "stochastic sparse gridworld actions sample 2"
